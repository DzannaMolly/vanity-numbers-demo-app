...
resource "aws_lambda_permission" "allow_api_gateway" {
  ...
  source_arn    = "arn:aws:execute-api:${var.aws_region}:${var.account_id}:${aws_api_gateway_rest_api.test_api.id}/*/POST/${aws_api_gateway_resource.test_resource.path_part}"
}
